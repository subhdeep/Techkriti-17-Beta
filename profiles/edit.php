...
">
                ...
                <h5><span>Roll No. :</span><input id="rollno" ></h5>
                <h5><span> Class :</span><input id="class" ></h5>
                <h5><span>City :</span>      <select id="city" name="city">
                ...
                <h5><span>Phone :</span><input id="phoneno" > </h5>
                <h5><span>Email :</span><input id="email" ></h5>
                <h5><span>School :</span> <input id="school" list="schood">                       
          <datalist id="schood">
             <option value="kv">kv</option>
             <option value="dps">dps</option>
           </datalist></h5>
        <h3><a id='submit'><button class="button1">Submit</button></a></h3>
              </div>
