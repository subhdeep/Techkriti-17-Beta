...
if (empty($_POST["centre"])&&($flag==0)) {
    $response= "Centre Name is required";
    $flag = 1;
  } 
...
$id=0;
     $sql = "INSERT INTO `groups_17` (id, members, team, competition,centre)
	     VALUES (NULL, '$members', '$team', '$competitions','$centre')";
     $result=$conn->query($sql);
$sql="SELECT * FROM `groups_17` WHERE members='$members' AND team='$team' AND competition='$competitions' AND centre='$centre'";
     $result=$conn->query($sql);
